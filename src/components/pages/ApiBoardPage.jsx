...
import { formatCurrency, formatDateTime } from '../../util/formatters'; // 포맷팅 함수 임포트
...
function ApiBoardPage() {
    ...
    const filterGroupStyle = { // 필터 그룹 스타일 (기존 유지)
        display: 'flex',
        ...
        <div style={containerStyle}>
            ...
            <div style={filterContainerStyle}>
                ...
                <div style={filterGroupStyle}>
                    <label htmlFor="cltrNm" style={labelStyle}>물건명</label>
                    <input
                        type="text"
                        id="cltrNm"
                        value={cltrNm}
                ...
                <div style={filterGroupStyle}>
                    <label htmlFor="sido" style={labelStyle}>시/도</label>
                    <input
                        type="text"
                        id="sido"
                        value={sido}
                ...
                <div style={filterGroupStyle}>
                    <label htmlFor="sgk" style={labelStyle}>시군구</label>
                    <input
                        type="text"
                        id="sgk"
                        value={sgk}
                ...
                <div style={filterGroupStyle}>
                    <label htmlFor="emd" style={labelStyle}>읍면동</label>
                    <input
                        type="text"
                        id="emd"
                        value={emd}
